...
episode_reward_level_1 = loadmat(r'C:\Users\tripats\Documents\GitHub\Results_DQN_Pytorch\Dynamic_Environment\Run102_Dynamic\Level 1- Implicit Info Exchange\connected_user.mat')
episode_reward_level_2 = loadmat(r'C:\Users\tripats\Documents\GitHub\Results_DQN_Pytorch\Dynamic_Environment\Run102_Dynamic\Level 2 - Reward Info Exchange\connected_user.mat')
episode_reward_level_3 = loadmat(r'C:\Users\tripats\Documents\GitHub\Results_DQN_Pytorch\Dynamic_Environment\Run102_Dynamic\Level 3 - Position Info Exchnage (Distance Penalty)\connected_user.mat')
...
fig = plt.figure()
plt.plot(num_episode_1, episode_reward_1, 'r', label='Level 1: Implicit')
plt.plot(num_episode_2, episode_reward_2, 'g', label='Level 2: Reward exchange')
...
plt.title("Connected Users vs Episode with Dynamic Users")
plt.show()
