...
if __name__ == "__main__":
    ...
    savemat(f'custom_logs\lvl_{args.args.info_exhange_lvl}\episodic_reward.mat', mdict)
    mdict_2 = {'num_episode':range(0, num_episode),'connected_user': episode_user_connected}
    savemat(f'custom_logs\lvl_{args.args.info_exhange_lvl}', mdict_2)
    ...
    plt.savefig(custom_dir + f'final_users.png')
    fig_4 = plt.figure()
    final_render(best_state, "best")
    print(states_fin)
    plt.savefig(custom_dir + f'best_users.png')
